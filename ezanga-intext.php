...
Description: This plugin will automatically connect to eZanga's network and place InText advertisements on your website.
...
<form method="POST" name="intext_form" id="intext_form">
    <fieldset>
        ...
        <p> This plugin will automatically connect to eZanga's network and place InText advertisements on your website.</p>
    </fieldset>
    <fieldset>
    <!-- == -->
