...
<form method="POST" name="intext_form" id="intext_form">
    <fieldset>
        <img src="<?php echo PATH; ?>/images/logo-ezanga-main-400x200.png" width="350" height="175">
...
?>
    ...
    /* intext form */
        ...
        #intext_form label{position:relative; display:block; width:auto;margin-top:20px;font-weight:900;}
        ...
        #intext_form .help-btn{display: inline-block; position: absolute; top: 0; right:0; width:28px; height:18px; background: url("<?php echo PATH ?>/images/help_btn.png") no-repeat 10px 0;cursor:pointer;}
...
?>
        ...
        <script type="text/javascript" src="http://cdn.ezanga.com/scripts/intext_advert.js"></script>     
        <!-- eZanga InText END --> 
