...
?>
    ...
    /* intext form */
        ...
        #intext_form .help-btn{display: inline-block; position: absolute; top: 0; right:0; width:28px; height:18px; background: url("<?php echo PATH ?>/help_btn.png") no-repeat 10px 0;cursor:pointer;}
